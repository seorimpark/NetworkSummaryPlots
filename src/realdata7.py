...
#Read data files
G=nx.read_edgelist("../data/bn-mouse_retina_1.edges")
...
violinplot(tk,kmax,"Network summary of the mouse retina network","alpha="+str(alpha)+", nb_vx="+str(len(M))+", sub_size="+str(size))