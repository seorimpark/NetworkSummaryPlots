...
l=[]
p=-math.inf
with open ("../data/scinet.csv","r") as file:
    for line in file:
        a1,b1,c=line.split(",")
        a=int(a1)
        b=int(b1)
...
violinplot(tk,kmax,"Network summary of scientific collaborations in network science","alpha="+str(alpha)+", nb_vx="+str(len(M))+", sub_size="+str(size))