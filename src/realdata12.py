...
l=[]
p=-math.inf
with open ("../data/crime.csv","r") as file:
    for line in file:
        a1,b1=line.split(",")
        a=int(a1)
        b=int(b1)
...
violinplot(tk,kmax,"Network summary of crimes in St. Louis in the 1990","alpha="+str(alpha)+", nb_vx="+str(len(M))+", sub_size="+str(size))